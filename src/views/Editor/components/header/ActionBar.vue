<template>
  <div class="action-bar__wrapper">
    ...
    <mdc-menu-anchor>
      <button v-tooltip="'Open...'" class="action-btn" @click="showLoadFromMenu">
    ...
    <mdc-menu-anchor>
      <button v-tooltip="'Download...'" class="action-btn" @click="showDownloadMenu">
...
import { downloadProject, loadVueggProject } from '@/store/types'
...
export default {
  ...
  methods: {
    ...
    ...mapActions([downloadProject, loadVueggProject])
  }
}
</script>
